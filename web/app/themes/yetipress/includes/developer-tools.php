...
add_action( 'admin_bar_menu', 'imp_clear_transients_node', 99 );
/**
 * Clear all transients with one click.
 *
 * @since 2.0.0
 */
function imp_clear_transients_node( $wp_admin_bar ) {
...
add_action( 'admin_bar_menu', 'imp_cron_count_node', 99 );
/**
 * Show the length of the scheduled cron task list.
 *
 * @since 2.0.0
 */
function imp_cron_count_node( $wp_admin_bar ) {
