...
add_filter( 'gallery_style', 'imp_gallery_style' );
/**
 * Remove the injected styles for the [gallery] shortcode.
 *
 * @since 2.0.0
 */
function imp_gallery_style( $css ) {
...
add_filter( 'the_content_more_link', 'imp_more_tag_excerpt_link' );
/**
 ...
 * @since 2.0.0
 */
function imp_more_tag_excerpt_link() {

	return ' <a class="more-link" href="' . get_permalink() . '">' . __( 'Read more &rarr;', CHILD_THEME_TEXT_DOMAIN ) . '</a>';

}

add_filter( 'excerpt_more', 'imp_truncated_excerpt_link' );
add_filter( 'get_the_content_more_link', 'imp_truncated_excerpt_link' );
/**
 ...
 * @since 2.0.0
 */
function imp_truncated_excerpt_link() {
...
// add_filter( 'genesis_post_info', 'imp_post_info' );
/**
...
// add_filter( 'genesis_post_meta', 'imp_post_meta' );
/**
 ...
 * @since 2.0.0
 */
function imp_prev_link_text( $text ) {

	return html_entity_decode('&#10216;') . ' ';

}

add_filter( 'genesis_next_link_text', 'imp_next_link_text' );
/**
 ...
 * @since 2.0.0
 */
function imp_next_link_text( $text ) {
 ...
 * @since 2.0.0
 */
add_filter( 'the_password_form', 'imp_password_form' );
function imp_password_form( $post = 0 ) {
